...
(defun dotspacemacs/user-config ()
  ...
  (defun endless/python-mode-hook ()
    (setq indent-tabs-mode nil))
  (add-hook 'python-mode-hook #'endless/python-mode-hook)
  (add-hook 'python-mode-hook
            (function (lambda ()
